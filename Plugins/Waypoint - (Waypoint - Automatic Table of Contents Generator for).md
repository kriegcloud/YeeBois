[latest waypoint documentation](obsidian://show-plugin?id=waypoint)
...
%% Error: Cannot create a landmark in a note that's not the folder note. For more information, check the instructions [here](https://github.com/IdreesInc/Waypoint) %%
...
- **Permanent and portable**
    - Unlike other plugins, Waypoints are generated and saved as real markdown text within your folder notes. If you decide to switch to a different markdown editor that supports [links](app://obsidian.md/links), all of your tables of contents will still be usable.
