import { db } from '@dank/drizzle';
import { eq } from '@dank/drizzle/orm';
import { accounts, authenticators } from '@dank/drizzle/schema';
import type { Authenticators } from '@dank/drizzle/shared';
import { typeIdGenerator } from '@dank/utils/typeid';
